...
will be generalised to handle both increasing and decreasing
concentration–response curves. Currently only
[`nsec_multi()`](https://open-aims.github.io/toxval/dev/reference/nsec_multi.md)
supports both directions; this capability will be folded into the main
[`nsec()`](https://open-aims.github.io/toxval/dev/reference/nsec.md)
function, with
[`nsec_multi()`](https://open-aims.github.io/toxval/dev/reference/nsec_multi.md)
becoming a deprecated special case for multivariate responses.
[`ecx()`](https://open-aims.github.io/toxval/dev/reference/ecx.md) may
also be extended to support stimulatory (hormetic) effects where a
biologically meaningful upper bound exists.
